...
public class GeocodingTestController {
    ...
    private static final String nominatimUrl = "https://nominatim.openstreetmap.org/search?format=json&q=";
    private static final String apiUrl = "https://api.openrouteservice.org/v2/directions/";
    private static final String optimizationUrl = "https://api.openrouteservice.org/optimization";
